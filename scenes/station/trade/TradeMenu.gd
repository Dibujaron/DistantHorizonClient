...
func instantiate_commodity_menu(commodity_info, hold_contents):
	...
	var itemIcon = commodity_columns.get_node_or_null("ItemCol/" + commodity_identifying_name)
	if itemIcon == null:
	...
	var inHoldCtBox = commodity_columns.get_node_or_null("OnShipCol/" + commodity_identifying_name)
	if inHoldCtBox == null:
	...
	var buyButton = commodity_columns.get_node_or_null("BuyCol/" + commodity_identifying_name)
	if buyButton == null:
	...
	var sellButton = commodity_columns.get_node_or_null("SellCol/" + commodity_identifying_name)
	if sellButton == null:
	...
	var onStationCtBox = commodity_columns.get_node_or_null("OnStationCol/" + commodity_identifying_name)
